<?php
   ...
   if (isset($_POST["submit"])) {
       $idpenilaianlama = $_POST["idpenilaianlama"];
       $idpenilaian = $_POST["idpenilaian"];
       $aspek = $_POST["aspek"];
       $markahpenuh = $_POST["markahpenuh"];
       
       $sql = "update penilaian set idpenilaian = '$idpenilaian', aspek = '$aspek', markahpenuh = '$markahpenuh'
               where idpenilaian = '$idpenilaianlama'";
...
<form class="panjang" action="penilaian_update.php" method="post">
    <input type="hidden" name="idpenilaianlama" value="<?php echo $idpenilaian; ?>">
    <table>
        <tr>
            <td>ID Penilaian</td>
